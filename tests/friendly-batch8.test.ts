...
assert.match(details, /operational && shouldShowFriendlyManagement/)
...
console.log('PASS: 70 cross-batch Friendly assertions for complete contracts, role/status safety, scoring, realtime, results, cache lifecycle, responsive UI and accessibility')
