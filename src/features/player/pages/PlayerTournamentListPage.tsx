...
const PlayerTournamentListPage = () => {
  ...
  return (
    <div className="player-tournament-page -mx-0 space-y-6 px-4 py-5 sm:px-6 sm:py-8">
      ...
      <section className="player-surface-card rounded-2xl border p-4 shadow-sm sm:p-5">
      ...
      <div className="space-y-4">
        {publishedTournaments.map(tournament => {
          ...
          return (
          <article key={tournament.id} className="player-surface-card rounded-2xl border p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-lime-300 hover:shadow-lg">
